...
```{r horse-plot, echo=FALSE, out.width="50%", fig.cap="Figure 1: Horse populations for all provinces in Canada from 1906 - 1972"}
...
knitr::kable(horses_sd_table, caption = "Horse sd table")
```
...
```{r horse-sd-plot, echo=FALSE, out.width="50%", fig.cap="Figure 2: Horse populations for the province with the largest standard deviation"}
knitr::include_graphics("../../results/horse_pop_plot_largest_sd.png")
```

In Figure \@ref(fig:horse-sd-plot) we zoom in and look at the province of `r maxsd`, which had the largest spread of values in terms of standard deviation.
